class Article < ActiveRecord::Base
  ...
  validates :year,
            ...
            format: { with: VALID_YEAR_REGEX,
                      message: 'i formatet (åååå) eller (åååå-mm-dd).' },
            length: { maximum: 10 }
  ...
  validates :book_id, presence: true, unless: proc { |a| a.author_id? }
  validates :author_id, presence: true, unless: proc { |a| a.book_id? }
end
